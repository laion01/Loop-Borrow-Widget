...
(function() {
    ...
    var data = {
        ...
        "permissions": { "__ogt_event_settings": { "read_container_data": {} }, "__ogt_cross_domain": { "read_container_data": {} }, "__ogt_google_signals": { "read_container_data": {} }, "__set_product_settings": { "read_container_data": {} } }

        ,
        "security_groups": {
            "google": ["__ogt_event_settings", "__ogt_cross_domain", "__ogt_google_signals", "__set_product_settings"]
        }
    ...
    */
    ...
    var ya = function() {
        ...
        var b = {},
            ...
            e = {
                ...
                fh: function() { c && a(c, 1) },
                Yj: function(f) { d = f },
                Nb: function(f) { d && a(d, f) },
                wk: function(f, g) {
                    b[f] = b[f] || { fe: 0 };
                    b[f].max = g
                },
                xj: function(f) { return b[f] && b[f].fe || 0 },
                reset: function() { b = {} },
                jj: a
            };
        e.onFnConsume = e.Wj;
    ...
    var Aa = function(a, b, c, d) {
        if (!a.o.s)
            if (a.s.Nb(("string" === typeof b ? b.length : 1) + ("string" === typeof c ? c.length : 1)), d) {
                var e = a.o;
                e.set(b, c);
                e.I["dust." + b] = !0
            } else a.o.set(b, c)
    ...
    var Ya = function(a, b, c) { return a && a.hasOwnProperty(b) ? a[b] : c },
        ...
        gb = function(a, b) {
            ...
            b = b || ",";
            var c = [];
            Pa(a, function(d, e) { fb.test(d) && e && c.push(d) });
            return c.join(b)
        },
        hb = function(a, b) {
    ...
    var lb = function(a, b) { for (var c, d = 0; d < b.length && !(c = kb(a, b[d]), c instanceof pa); d++); return c },
        kb = function(a, b) {
            try { var c = a.get(String(b[0])); if (!(c && c instanceof ib)) throw Error("Attempting to execute non-function " + b[0] + "."); return c.g.apply(c, [a].concat(b.slice(1))) } catch (e) {
                var d = a.I;
    ...
    ob.prototype.C = function(a, b) {
        var c = Ca(this.g);
        c.g = a;
        for (var d, e = 1; e < arguments.length; e++) d = d = kb(c, arguments[e]);
        return d
    };
    var rb, sb = function() {
        if (void 0 === rb) {
            var a = null,
                b = na.trustedTypes;
            if (b && b.createPolicy) {
                try { a = b.createPolicy("goog#html", { createHTML: oa, createScript: oa, createScriptURL: oa }) } catch (c) { na.console && na.console.error(c.message) }
                rb = a
            } else rb = a
        }
        return rb
    ...
    */
    ...
    function Lb(a, b) {
        var c = [new Jb(Mb[0].toLowerCase(), Hb)];
        if (0 === c.length) throw Error("No prefixes are provided");
        var d = c.map(function(f) {
                var g;
                if (f instanceof Jb) g = f.g;
                else throw Error("");
                return g
            }),
            e = b.toLowerCase();
            ...
            var d = [],
                ...
                g = function(h) {
                    ...
                    if ("function" === typeof h) {
                        var r = new ib("", function(x) { for (var w = Array.prototype.slice.call(arguments, 0), A = 0; A < w.length; A++) w[A] = yc(z(this, w[A]), b, !!c); return g((0, this.g.P)(h, h, w)) });
                        d.push(h);
                        e.push(r);
                        f(h, r);
                        return r
    ...
    var zc = function(a) { for (var b = [], c = 0; c < a.length(); c++) a.has(c) && (b[c] = a.get(c)); return b },
        Ac = function(a) {
            if (void 0 === a || Ja(a) || vc(a)) return !0;
            switch (typeof a) {
                case "boolean":
                case "number":
                case "string":
    ...
    var Cc = "charAt concat indexOf lastIndexOf match replace search slice split substring toLowerCase toLocaleLowerCase toString toUpperCase toLocaleUpperCase trim".split(" "),
        ...
        Ic = function(a, b, c) {
            ...
            if (a instanceof ib || a instanceof mb) {
                ...
                if ("toString" === b) return a instanceof ib ? a.P : a.toString();
    ...
    function Uc(a, b, c) {
        if ("string" === typeof b) return Tc(a, function() { return b.length }, function(f) { return f }, c);
        if (b instanceof mb || b instanceof va || b instanceof ib) {
            var d = b.Kb(),
                e = d.length();
            return Tc(a, function() { return e }, function(f) { return d.get(f) }, c)
        }
    }
    var Vc = function(a, b, c) {
            ...
            c = z(this, c);
            var d = this.g;
            return Uc(function(e) { d.set(a, e); return d }, b, c)
        },
        Wc = function(a, b, c) {
            a = z(this, a);
            b = z(this, b);
    ...
    var bd = function(a, b, c, d) {
            ...
            for (e(g, h); kb(h, b);) {
                var k = lb(h, d);
                if (k instanceof pa) { if ("break" === k.g) break; if ("return" === k.g) return k }
                var n = Ca(g);
                e(h, n);
                kb(n, c);
                h = n
        ...
        dd = function(a, b) {
            ...
            if (a instanceof mb || a instanceof va || a instanceof ib) c = a.get(b);
    ...
    var Ie = function(a) {
            ...
            for (var c = [], d = [], e = Ge(a), f = 0; f < oe.length; f++) {
                var g = oe[f],
                    h = He(g, e);
                if (h) {
    ...
    var Pe = function() {
            ...
            Pa(a, function(f, g) {
                ...
                c.g[f] = function(k, n) {
                    var p = h[k];
                    if (!p) throw Oe(k, {}, "The requested permission " + k + " is not configured.");
    ...
    function Ne(a, b) {
        ...
        c.vtp_createPermissionError = Oe;
        try { return xe(c) } catch (d) { return { assert: function(e) { throw new Be(e, {}, "Permission " + e + " is unknown."); }, U: function() { for (var e = {}, f = 0; f < arguments.length; ++f) e["arg" + (f + 1)] = arguments[f]; return e } } }
    }
    ...
    var bf = function(a) {
            ...
            Pa(a, function(e, f) {
                if (void 0 !== f)
                    ...
                    for (var k = Ze(f).split("/", 5), n = 0; n < k.length; n++) {
                        var p = af[n],
                            q = k[n];
                        b.hasOwnProperty(p) || (b[p] = q)
                    } else 10 > c && (b["k" + c] = Ze(Xe(e, 40)), b["v" + c] = Ze(f), c++)
            });
            var d = [];
            Pa(b, function(e, f) { d.push("" + e + f) });
            return d.join("~")
        },
    ...
    var cf = function(a) {
            var b = [];
            Pa(a, function(c, d) { null != d && b.push(encodeURIComponent(c) + "=" + encodeURIComponent(String(d))) });
            return b.join("&")
        },
        df = function(a, b, c, d) {
            this.Ea = a.Ea;
    ...
    ef.prototype.C = function(a) {
        var b = 20 > this.events.length && 16384 > a.I + this.s,
            c = this.Ea === a.s && this.g === a.o && this.o === a.C;
    ...
    var ff = function(a, b) { Pa(a, function(c, d) { null != d && b.push(encodeURIComponent(c) + "=" + encodeURIComponent(d)) }) },
        ...
        hf = function(a, b) {
            ...
            ff(g, d);
            b && d.push("_s=" + b);
            for (var h = d.join("&"), k = [], n = {}, p = 0; p < c.length; n = { Gd: n.Gd }, p++) {
                var q = [];
                n.Gd = {};
    ...
    var zf = function(a, b) {
            var c = new ib(a, function() { for (var d = Array.prototype.slice.call(arguments, 0), e = 0; e < d.length; e++) d[e] = z(this, d[e]); return b.apply(this, d) });
            c.Lb();
            return c
        },
        Af = function(a, b) {
        ...
        function b(c) {
            return function(d) {
                try { return c(d) } catch (e) {
                    (Ue || We) && a.call(this, e.message)
                }
            }
        }
        return { parse: b(function(c) { return xc(JSON.parse(c)) }), stringify: b(function(c) { return JSON.stringify(yc(c)) }) }
    };
    ...
    function tg() {
        ...
        a.ics || (a.ics = { entries: {}, set: ug, update: vg, addListener: wg, notifyListeners: xg, active: !1, usedDefault: !1, usedUpdate: !1, accessedDefault: !1, accessedAny: !1, wasSetLate: !1 });
        return a.ics
    }
    ...
    var zg = function(a) {
        ...
        Gg = function(a, b) {
            ...
            if (c()) {
                var d = !1;
                Eg(b, function(e) { d || c() || (d = !0, a(e)) })
            } else a({})
        },
        Hg = function(a, b) {
            function c() { for (var f = [], g = 0; g < d.length; g++) { var h = d[g];!1 === zg(h) || e[h] || (f.push(h), e[h] = !0) } return f }
            var d = Fa(b) ? [b] : b,
                e = {};
            c().length !== d.length && Eg(d, function(f) {
                var g = c();
    ...
    var Lg = [T.D, T.R],
        Mg = function(a) {
            ...
            var c = a[T.ag];
            c && og(41);
            for (var d = Ja(b) ? b : [b], e = { Cc: 0 }; e.Cc < d.length; e = { Cc: e.Cc }, ++e.Cc) Pa(a, function(f) {
                return function(g, h) {
                    if (g !== T.Ee && g !== T.ag) {
                        var k = d[f.Cc],
                            n = jg.hh,
        ...
        Ng = 0,
        Og = function(a, b) {
            Pa(a, function(e, f) { tg().update(e, f) });
            Fg(b);
            var c = Xa(),
                d = c - Ng;
            Ng && 0 <= d && 1E3 > d && og(66);
    ...
    var $g = function(a) { return null == a ? "" : Fa(a) ? Va(String(a)) : "e0" },
        ...
        ph = function(a, b) {
            function c(n, p, q) {
                var r = n[p];
                Ja(r) || (r = [r]);
                for (var t = 0; t < r.length; ++t) { var u = $g(r[t]); "" !== u && f.push({ name: p, value: q(u), index: void 0 }) }
            }
    ...
    var ui = function(a) {
            ...
            b = si(b, function(c) { return !ai(c.element) });
            return b[0]
        },
    ...
    var yi = function(a) {
        ...
        Ei = function(a) {
            ...
            if (a.xb && a.xb.email) {
                ...
                var K = a && a.jd;
                if (K && 0 !== K.length) {
                    for (var J = [], R = 0; R < x.length; R++) {
                        for (var N = !0, M = 0; M < K.length; M++) { var V = K[M]; if (V && Xg(x[R].element, V)) { N = !1; break } }
                        N && J.push(x[R])
                    }
                    Q = J
                } else Q = x;
        ...
        Ii = function(a) {
            if (a) switch (a.mode) {
                ...
                case "auto_detect":
                    ...
                    var c = a.auto_detect;
                    if (c) {
                        var d = Ei({ ue: !1, ve: !1, jd: c.exclude_element_selectors, xb: { email: !!c.email, phone: !!c.phone, Zg: !!c.address } }).elements,
                            e = {};
                        if (0 < d.length)
    ...
    var Ti = function(a, b, c, d) { return Ri(d) ? Ni(a, String(b || Si()), c) : [] },
        Wi = function(a, b, c, d, e) {
            if (Ri(e)) {
                ...
                if (0 !== f.length) {
                    f = Vi(f, function(g) { return g.je }, b);
                    if (1 === f.length) return f[0].id;
                    f = Vi(f, function(g) { return g.vd }, c);
    ...
    function Xi(a, b, c, d) {
        var e = Si(),
            f = window;
        Qi(f) && (f.document.cookie = a);
        var g = Si();
        return e != g || void 0 != c && 0 <= Ti(b, g, !1, d).indexOf(c)
    }
    var aj = function(a, b, c, d) {
            ...
            if (n && "auto" === n.toLowerCase()) {
                for (var p = Zi(), q = void 0, r = !1, t = 0; t < p.length; ++t) {
                    var u = "none" !== p[t] ? p[t] : void 0,
                        v = e(g, "domain", u);
                    v = f(v, c.flags);
                    try { d && d(a, h) } catch (y) { q = y; continue }
                    r = !0;
                    if (!$i(u, c.path) && Xi(v, a, b, c.lb)) return 0
                }
                if (q && !r) throw q;
                return 1
            }
    ...
    function Ui(a, b, c) {
        for (var d = [], e = Ti(a, void 0, void 0, c), f = 0; f < e.length; f++) {
            var g = e[f].split("."),
                h = g.shift();
            if (!b || -1 !== b.indexOf(h)) {
                var k = g.shift();
                k && (k = k.split("-"), d.push({ id: g.join("."), je: 1 * k[0] || 1, vd: 1 * k[1] || 1 }))
            }
        }
        return d
    }
    ...
    function kj(a, b, c) {
        ...
        0 !== e && (d = new Date((b || Xa()) + 1E3 * (e || 7776E3)));
    ...
    var lj = ["1"],
        ...
        rj = function(a, b) {
            b = void 0 === b ? !0 : b;
            var c = oj(a.prefix);
            if (!mj[c] && !pj(c, a.path, a.domain) && b) {
                var d = oj(a.prefix),
                    e = fj();
                if (0 === qj(d, e, a)) {
    ...
    function pj(a, b, c) {
        var d = ij(a, b, c, lj, "ad_storage");
        if (!d) return !1;
        var e = d.split(".");
        5 === e.length ? (mj[a] = e.slice(0, 2).join("."), nj[a] = { id: e.slice(2, 4).join("."), vh: Number(e[4]) || 0 }) : 3 === e.length ? nj[a] = { id: e.slice(0, 2).join("."), vh: Number(e[2]) || 0 } : mj[a] = d;
        return !0
    }
    ...
    function Lj(a, b) {
        var c = [m.navigator.userAgent, (new Date).getTimezoneOffset(), Ob.userLanguage || Ob.language, Math.floor(Xa() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"),
            d;
        if (!(d = zj)) {
        ...
        zj = d;
        for (var k = 4294967295, n = 0; n < c.length; n++) k = k >>> 8 ^ zj[(k ^ c.charCodeAt(n)) & 255];
        return ((k ^ -1) >>> 0).toString(36)
    }

    function Nj() {
        return function(a) {
            var b = pi(m.location.href),
                c = b.search.replace("?", ""),
                d = ki(c, "_gl", !1, !0) || "";
            a.query = Oj(d) || {};
            var e = ni(b, "fragment").match(Kj("_gl"));
            a.fragment = Oj(e && e[3] || "") || {}
        }
    }
        ...
        for (var k in f)
            if (f.hasOwnProperty(k)) a: {
                var n = k,
                    p = f[k],
                    q = a;
                if (q.tagName) { if ("a" === q.tagName.toLowerCase()) { Wj(n, p, q, void 0); break a } if ("form" === q.tagName.toLowerCase()) { Vj(n, p, q); break a } }
                "string" == typeof q && Tj(n, p, q, void 0)
            }
    }
    ...
    function Aj(a) {
        try {
            ...
            var e = b;
            if (e) { var f = e.protocol; "http:" !== f && "https:" !== f || Uj(e, e.hostname) }
        } catch (g) {}
    }
                ...
                var f = mk(e),
                    g = function() {
                        for (var h = {}, k = 0; k < a.length; ++k) {
                            var n = rk(a[k], f);
                            if (n) {
                                var p = Ti(n, H.cookie, void 0, "ad_storage");
    ...
    function zk(a, b) {
        var c = mk(b),
            d = rk(a, c);
        if (!d) return 0;
        for (var e = hk(d), f = 0, g = 0; g < e.length; g++) f = Math.max(f, e[g].timestamp);
        return f
    }
    ...
    function sl(a) {
        if (!pl) {
            ...
            if (!a || "readystatechange" != a.type || c || !b && d) { pl = !0; for (var e = 0; e < rl.length; e++) I(rl[e]) }
    ...
    var Cl = function() {
            ...
            if (!U._li && m.performance && m.performance.timing) {
    ...
    var Ul = function(a) {},
        ...
        $l = function(a) {
            ...
            var c = mg("GTM"),
                d = mg("TAGGING");
            return [qm, gm[b] ? "" : "&es=1", rm[b], Ul(b), c ? "&u=" + c : "", d ? "&ut=" + d : "", Zl(), hm, im, pm, om, Yl(a), nm, mm, "&z=0"].join("")
        },
        tm = function() { qm = sm() },
    ...
    var km = function(a, b) {
            ...
            return {
                Lj: function() { return c < a ? !1 : Xa() - d[c % a] < b },
                ik: function() {
                    var f = c++ % a;
                    d[f] = Xa()
                }
    ...
    function Om(a, b, c, d) {
        ...
        if (g && g.length) {
            var h = g[0];
            f = Om(h.index, { onSuccess: f, onFailure: 1 === h.lh ? b.terminate : f, terminate: b.terminate }, c, d)
        }
        return f
    }
    ...
    function Pm(a, b, c, d) {
        ...
        if (n && n.length) {
            var p = n[0],
                q = Om(p.index, { onSuccess: g, onFailure: h, terminate: k }, c, d);
            if (!q) return null;
            g = q;
            h = 2 === p.lh ? k : q
        }
    ...
    function Qm(a, b, c) {
        var d = [],
            e = [];
        b[a] = Rm(d, e, c);
        return { onSuccess: function() { b[a] = Sm; for (var f = 0; f < d.length; f++) d[f]() }, onFailure: function() { b[a] = Tm; for (var f = 0; f < e.length; f++) e[f]() } }
    }
    ...
    function dn(a, b, c, d) {
        ...
        d = void 0 === d ? "" : d;
        if (a === b) return [];
        var e = function(q, r) { var t = r[q]; return void 0 === t ? an[q] : t },
            f;
        for (f in fn(a, b))
            if (!Zm[f]) {
                var g = (d ? d + "." : "") + f,
    ...
    l.getEventModelKeys = function() {
        var a = [],
            b;
        for (b in this.eventModel) b !== T.Ib && this.eventModel.hasOwnProperty(b) && void 0 !== this.eventModel[b] && a.push(b);
        return a
    };
    ...
    var Hn = function(a, b, c) {
            ...
            if (0 === h)
                if (a.purpose && a.vendor) {
                    var n = Gn(a.vendor.consents, void 0 === d ? "755" : d);
                    k = n && "1" === b && a.purposeOneTreatment && "CH" === a.publisherCC ? !0 : n && Gn(a.purpose.consents, b)
                } else k = !0;
    ...
    var Tn = function() {
        ...
        if (!0 === m.gtag_enable_tcf_support && !a.active && ("function" === typeof m.__tcfapi || "function" === typeof b.o.__tcfapi || null != In(b))) {
            ...
            Pn();
            var c = null;
            Kn ? c = m.setTimeout(function() {
                Qn(a);
                Rn(a);
                c = null
            }, Nn) : a.tcString = "tcunavailable";
            try {
    ...
    function Sn() {
        var a = {},
            b;
        for (b in Ln) Ln.hasOwnProperty(b) && (a[b] = !0);
        return a
    }
    ...
    function Ko() {
        if (Ea(Ob.joinAdInterestGroup)) return !0;
        Jo || (Bn(''), Jo = !0);
        return Ea(Ob.joinAdInterestGroup)
    }

    function Lo(a, b) {
        var c = void 0;
        try { c = H.querySelector('iframe[data-tagging-id="' + b + '"]') } catch (e) {}
        if (c) { var d = Number(c.dataset.loadTime); if (d && 6E4 > Xa() - d) { lg("TAGGING", 9); return } } else try { if (50 <= H.querySelectorAll('iframe[allow="join-ad-interest-group"][data-tagging-id*="-"]').length) { lg("TAGGING", 10); return } } catch (e) {}
        ...
        ar = function(a, b, c) {
            if (b) {
                ...
                if (d && 1 === $q(a, b).status) {
                    $q(a, b).status = 2;
                    var e = {};
                    zm && (e.timeoutId = m.setTimeout(function() {
                        og(38);
                        em()
                    }, 3E3));
                    ...
                    Xq[d.containerId] = Xa();
                    if (sn()) {} else {
                        var g = "/gtag/js?id=" + encodeURIComponent(d.containerId) + "&l=" + L.ca + "&cx=c";
                        Xm() && (g += "&sign=" + L.$d);
            ...
            if (d.V) {
                ...
                if (f) {
                    var g = wc(c),
                        ...
                        u = pn(on(qn(nn(ln(mn(kn(jn(hn(g), h), k), n), p), function() {
                            Mm(q, r, "2");
                            t()
                        }), function() {
                            Mm(q, r, "3");
                            t()
                        }), function(v, y) { a.C[v] = y }), function(v) { return a.C[v] });
                    try {
                        Mm(q, r, "1"), en(d.type, d.V, u);
                        f(d.V, b, d.s, u)
                    } catch (v) {
                        Mm(q, r, "4");
                    }
    ...
    l.register = function(a, b, c) {
        ...
        if (3 !== d.status) {
            d.s = b;
            d.status = 3;
            c && (wc(d.remoteConfig, c), d.remoteConfig = c);
            var e = mo(a),
                f = Xq[e.containerId];
            if (void 0 !== f) {
    ...
    l.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.g.length;) {
            var f = this.g[0];
            if (f.o) !f.V || $q(this, f.V).g ? (f.o = !1, this.g.push(f)) : c.push(f), this.g.shift();
            else {
                var g = void 0;
                switch (f.type) {
                    case "require":
                        ...
                        zm && m.clearTimeout(f.g[0].timeoutId);
                        break;
                    case "set":
                        Pa(f.g[0], function(r, t) { wc(eb(r, t), b.s) });
                        break;
                    case "config":
                        g = $q(this, f.V);
                        e.Za = {};
                        Pa(f.g[0], function(r) { return function(t, u) { wc(eb(t, u), r.Za) } }(e));
                        var h = !!e.Za[T.Ud];
                        delete e.Za[T.Ud];
                        var k = mo(f.V),
    ...
    var er = {},
        ...
        ir = function() {
            U.addTargetToGroup = function(e) { hr(e, "default") };
            U.addDestinationToContainer = function(e, f) { gr(e, f) };
            var a = U.pendingDefaultTargets;
            delete U.pendingDefaultTargets;
            if (Array.isArray(a))
                for (var b = 0; b < a.length; ++b) hr(a[b], "default");
    ...
    function qr(a) {
        if (sn()) {} else {
            ...
            Xm() && (c += "&sign=" + L.$d, Pb && (b = Pb.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0]));
            var d = qo("https://", "http://", b + c);
            Vb(d)
        }
    }
    var pr = function() {
    ...
    l.isActive = function(a, b) {
        var c = this.o[a];
        if (!c) return !0;
        if (!this.isActive(c.we, b)) return !1;
        for (var d = 0; d < c.Yb.length; d++)
    ...
    l.getIsAllowedFn = function(a, b) {
        ...
        for (var d = [], e = 0; e < c.Yb.length; e++) {
            var f = this.g[c.Yb[e]];
            f.Sb(b) && d.push(f)
        }
        if (!d.length) return function() { return !1 };
        var g = this.getIsAllowedFn(c.we, b);
        return function(h, k) {
            k = k || [];
            if (!g(h, k)) return !1;
    ...
    l.checkState = function(a, b) {
        var c = this.o[a];
        if (!c) return lr;
        var d = this.checkState(c.we, b);
        if (!d.active) return kr;
        for (var e = [], f = 0; f < c.Yb.length; f++) {
            var g = this.g[c.Yb[f]];
            g.Sb(b) && e.push(g)
        }
        return e.length ? {
    ...
    l.registerChild = function(a, b, c) {
        var d = this.o[a];
        if (!d && U[a] || d && d.we !== b) return !1;
        if (d) return d.Yb.push(c), !1;
        this.o[a] = { we: b, Yb: [c] };
        return !0
    };
    var rr = function(a, b) {
            this.g = [{ eventId: a, Sb: !0 }];
            this.o = null;
    ...
    rr.prototype.Sb = function(a) {
        for (var b = this.g.length - 1; 0 <= b; b--)
            if (this.g[b].eventId <= a) return this.g[b].Sb;
        return !1
    };
    rr.prototype.isAllowed = function(a, b) {
        b = b || [];
        if (!this.o || mr[a] || this.o[a]) return !0;
        for (var c = 0; c < b.length; ++c)
        ...
        zr = function(a, b) {
            for (var c = [], d = 0; d < qe.length; d++)
                if (a[d]) {
                    ...
                    var f = Bl(b.Mb);
                    try {
                        var g = Om(d, { onSuccess: f, onFailure: f, terminate: f }, b, d);
                        if (g) {
                            var h = c,
                                k = h.push,
                                n = d,
    ...
    var cs = {
            ...
            consent: function(a) {
                if (3 === a.length) {
                    ...
                    var b = Lh(),
                        c = a[1];
                    "default" === c ? Mg(a[2]) : "update" === c && Og(a[2], b)
                }
            },
            event: function(a) {
                var b = a[1];
                if (!(2 > a.length) && Fa(b)) {
                    ...
                    if (Fa(k) || Ja(k)) {
                        for (var n = k.toString().replace(/\s+/g, "").split(","), p = [], q = 0; q < n.length; q++)
            ...
            get: function(a) {
                og(53);
                if (4 !== a.length || !Fa(a[1]) || !Fa(a[2]) || !Ea(a[3])) return;
                var b = mo(a[1]),
                    c = String(a[2]),
                    d = a[3];
                if (!b) return;
                Kr || og(43);
                if (!bs() || -1 === Ir.indexOf(b.prefix)) return;
                Lh();
                var e = {};
            ...
            js: function(a) {
                if (2 == a.length && a[1].getTime) {
                    ...
                    bs();
                    var b = {};
                    return b.event = "gtm.js", b["gtm.start"] = a[1].getTime(), b["gtm.uniqueEventId"] = as(a), b
                }
            },
            policy: function(a) {
                if (3 === a.length) {
    ...
    es.prototype.push = function(a, b, c) {
    ...
    function Ns(a) {
        ...
        if (!a.event) return !1;
        c || (c = Lh(), a["gtm.uniqueEventId"] = c, Uh("gtm.uniqueEventId", c));
        return Hr(a)
    }
    ...
    function Ps() {
        for (var a = !1; !Js && (0 < Gs.length || 0 < Hs.length);) {
            ...
            if (null != g) {
                ...
                try {
                    if (Ea(g)) try { g.call(Sh) } catch (B) {} else if (Ja(g)) {
                        var q = g;
                        if (Fa(q[0])) {
                            var r = q[0].split("."),
                                t = r.pop(),
                                u = q.slice(1),
                                v = Rh(r.join("."), 2);
                            if (null != v) try { v[t].apply(v, u) } catch (B) {}
                        }
                    } else {
                        if (Qa(g)) {
                            a: {
    ...
    var at = function(a, b, c) {
            var d = { event: b, "gtm.element": a, "gtm.elementClasses": fc(a, "className"), "gtm.elementId": a["for"] || ac(a, "id") || "", "gtm.elementTarget": a.formTarget || fc(a, "target") || "" };
    ...
    function ou(a, b) {
        function c(g) {
            var h = pi(g),
                ...
                n = ni(h, "host", !0),
                p = ni(h, "port"),
                q = ni(h, "path").toLowerCase().replace(/\/$/, "");
    ...
    function qu(a) {
        ...
        switch (a["function"]) {
            ...
            case "_css":
                var f;
                a: {
                    if (b) try { for (var g = 0; g < ku.length; g++) { var h = ku[g]; if (b[h]) { f = b[h](c); break a } } } catch (k) {}
                    f = !1
                }
                return f;
            case "_ew":
    ...
    function py(a) {
        ...
        for (var b = a.Kb(), c = b.length(), d = 0; d < c; d++) {
            var e = b.get(d);
            e !== T.Ee && P(this, "access_consent", e, "write")
        }
        var f = this.g.g,
            g = Kx(f);
        if (oy) {
            var h = wr("consent", "default", yc(a)),
                k = f.eventId;
            Es.push(new Cs(h), k, g)
        } else Mg(yc(a))
    }
    ...
    function sy(a, b, c) {
        O(G(this), ["targetId:!string", "name:!string", "value:!*"], arguments);
        for (var d = b.split("."), e = Wq(a), f = 0; f < d.length - 1; f++) {
    ...
    function Ay(a) {
        ...
        if (zy) {
            var f = d.eventId;
            Es.push(new Cs(wr("consent", "update", b)), f, e)
        } else Og(b, d.eventId)
    }
    var By = function() {
        var a = new ag;
        ...
        return function(c) {
            ...
            if (a.g.hasOwnProperty(c)) d = a.get(c, this);
                ...
                if (e = a.o.hasOwnProperty(c)) {
                    var f = !1,
                        g = this.g.g;
                    if (g) { var h = g.md(); if (h) { 0 !== h.indexOf("__cvt_") && (f = !0); } }
                    e = f
                }
                if (e) {
    ...
    function Hy() {
        Ey.g.g.P = function(a, b, c) {
            U.SANDBOXED_JS_SEMAPHORE = U.SANDBOXED_JS_SEMAPHORE || 0;
            U.SANDBOXED_JS_SEMAPHORE++;
            try { return a.apply(b, c) } finally { U.SANDBOXED_JS_SEMAPHORE-- }
        }
    }

    function Iy(a) {
        void 0 !== a && Pa(a, function(b, c) {
            for (var d = 0; d < c.length; d++) {
                var e = c[d].replace(/^_*/, "");
                Kh[e] = Kh[e] || [];
                Kh[e].push(b)
    ...
    l.ph = function() {
        var a;
        a = Wz ? this.metadata.user_data : this.B(T.Ca);
    ...
    var Zz = !1,
        $z = function(a) {
            var b = a.eventName === T.Gc && Cg() && a.Ma(),
                ...
                g = (a.g || a.metadata.euid_mode_enabled) && a.rh();
            return !(!Ob.sendBeacon || c || g || d || e || f || b || Zz)
        };
    var aA = !1;
    ...
    var oA = function(a, b) {
            ...
            var d = lA(b),
                ...
                g = Number(b.B(T.Aa)),
                h = b.B(T.jc),
                k = { lb: T.R, domain: e, path: f, expires: g ? new Date(Xa() + 1E3 * g) : void 0, flags: "" + b.B(T.Ra) };
            if (!1 === h && mA(b) === a) c = !0;
            else {
                var n = jj(a, nA[0], e, f);
                c = 1 !== bj(d, n, k)
        ...
        mA = function(a) {
            var b = lA(a),
                ...
                e = ij(b, c, d, nA, T.R);
            if (!e) {
                var f = String(a.B(T.ic));
                f && f != b && (e = ij(f, c, d, nA, T.R))
            }
            return e
        },
    ...
    var sA = function(a, b) {
            var c = qA(b),
                ...
                f = Number(b.B(T.Aa)),
                g = jj(a, rA[0], d, e),
                h = { lb: T.R, domain: d, path: e, expires: f ? new Date(Xa() + 1E3 * f) : void 0, flags: String(b.B(T.Ra)) };
            return 1 !== bj(c, g, h)
        },
        tA = function(a) {
            var b = qA(a),
    ...
    var xA = function(a) {
            var b = a.B(T.ra),
                c = a.getRemoteConfig(T.ra);
            if (c === b) return c;
            var d = wc(b);
            c && c[T.T] && (d[T.T] = (d[T.T] || []).concat(c[T.T]));
            return d
        },
        ...
        DA = function(a) {
            ...
            Yj(function() {
                var d;
                if (Pg("analytics_storage")) d = {};
                else {
                    var e = {};
                    d = (e._up = "1", e[b] = a.M[T.Ha], e[c] = wA(a), e)
                }
                return d
            }, 1);
            return !Pg("analytics_storage") && CA() ? yA(b, c) : {}
        },
        CA = function() {
            var a = mi(m.location, "host"),
                b = mi(pi(H.referrer), "host");
    ...
    var HA = function(a) {
            var b;
            b = GA ? a.H[T.Sa] : a.B(T.Sa);
            return ni(pi(b), "host", !0)
        },
        IA = !1;
    var GA = !1;
    var JA = !1;
    ...
    var OA = function(a, b) {
        ...
        PA = function(a, b) {
            if (Cg() && (a.gcs = Qg(), b.qf && (a.gcu = "1"), b.Ma())) {
                Dg() && (a.gcd = Rg());
                var c = b.B(T.aa);
    ...
    var SA = function() {
        ...
        dB = function(a, b, c) {
            ...
            0 < a.$a && !UA && (f._et = a.$a);
            if (a.metadata.is_ecommerce || a.rf) {
                var p = a.H[T.da] || a.B(T.da);
                if (Ja(p))
            ...
            for (var u = function(C, E) {
                    ...
                    var F = C.split(".");
                    if (C === T.Ca && "object" !== typeof E) return u(C, E), !0;
                    if (F[0] === T.Ca) {
                        if ((1 < F.length || "object" === typeof E) && a.Ma()) {
                            var Q = QA(C, E);
                            Pa(Q, function(K, J) { return void u(K, J) })
                        }
                        return !0
                    }
                    return !1
            ...
            Pa(a.H, d);
            if (!XA) {
                var w = a.F.getKeysFromFirstOfAnyScope([T.cb, T.Ic, T.Jc, T.Kc, T.Lc, T.Mc, T.Nc]),
                    A = function(C, E) {
                        if (void 0 !== E) {
                            null === E && (E = "");
                            var F = cB[C];
                    ...
                    for (var p = eB(e, h), q = p.indexOf("\n\n"); - 1 !== q;) {
                        ...
                        a: {
                            var t = ea(p.substring(0, q).split("\n")),
                                u = t.next().value,
                                v = t.next().value;
                            if (u.startsWith("event: message") && v.startsWith("data: ")) try { r = JSON.parse(v.substring(v.indexOf(":") + 1)); break a } catch (Q) {}
                            r = void 0
                        }
                        if (r) {
                            var y = r.send_pixel || [];
    ...
    mB.prototype.s = function(a,
        ...
        var c = this,
            d;
        try { d = new dB(a, this.I, b) } catch (t) { a.abort() }
        var e = $z(a);
    ...
    var qB = function(a, b) {
            function c(q) { n.push(q + "=" + encodeURIComponent("" + a.Ea[q])) }
            var d = b.sk,
                e = b.tk,
                f = b.Fj,
                g = b.vf,
            ...
            if (d || e) {
                ...
                d && (jB("https://stats.g.doubleclick.net/g/collect", "v=2&" + n.join("&")), Jg("https://stats.g.doubleclick.net/g/collect?v=2&" + n.join("&")));
                if (e) {
                    n.push("z=" + La());
                    if (!k) {
    ...
    var rB = window,
        sB = document,
        tB = function(a) {
            var b = rB._gaUserPrefs;
            if (b && b.ioo && b.ioo() || a && !0 === rB["ga-disable-" + a]) return !0;
            try { var c = rB.external; if (c && c._gaUserPrefs && "oo" == c._gaUserPrefs) return !0 } catch (f) {}
            for (var d = Ni("AMP_TOKEN", String(sB.cookie), !0), e = 0; e < d.length; e++)
    ...
    var vB = function(a, b, c) {
            c || (c = function() {});
            var d = function(e) { void 0 !== e[b] && (e[b] = c(e[b])) };
            d(a.H);
            d(a.M);
            d(a.Ig);
            d(a.F.globalConfig)
    ...
    l.fk = function(a) {
        ...
        try {
            ...
            var D;
            a: {
                if (w) { var C = w.split("."); if (!(5 > C.length || 7 < C.length)) { D = { sessionId: C[0], ze: Number(C[1]), Ad: !!Number(C[2]), Lf: Number(C[3]), Tb: Number(C[4] || 0), Ub: "1" === C[5], ne: "0" !== C[6] ? C[6] : void 0 }; break a } }
                D = void 0
            }
            vA && (a.metadata.is_first_visit = !1, a.metadata.is_session_start = !1, a.metadata.join_timer_sec = 0);
            if (D && D.Tb) {
                var E = Math.max(0, D.Tb - Math.max(0, a.o - D.Lf));
            ...
            if (vA) {
                vp(a, T.Hb, D.sessionId);
                vp(a, T.Xc, D.ze);
                vp(a, T.Wc, D.Ad ? 1 : 0);
            } else {
                a.Ta(T.Hb, D.sessionId);
                a.Ta(T.Xc, D.ze);
                a.Ta(T.Wc, D.Ad ? 1 : 0);
            }
            var N =
            ...
            AB[6] && vp(a, T.Td);
            for (var Ia = a.B(T.af) || [], da = 0; da < Ia.length; da++) {
                var xa = Ia[da];
                if (xa.rule_result) {
                    AB[6] ? vp(a, T.Td, xa.traffic_type) : a.Ta(T.Td, xa.traffic_type);
                    bA(3);
                    break
                }
            }
            ...
            if (void 0 !== a.B(T.Rc)) IA && vp(a, T.Rc);
                                    ...
                                    for (var Mr = String(a.B(T.pb)), qf = Zi(), ie = 0; ie < qf.length; ie++)
                                        if ("none" !== qf[ie]) {
                                            var Nr = String(a.B(T.Ia)) +
                                                "_ga_autodomain";
                                            if (0 === bj(Nr, KA, { lb: T.R, domain: qf[ie], path: Mr })) {
                                                bj(Nr, void 0, { lb: T.R, domain: qf[ie], path: Mr });
                                                MA = qf[ie];
                                                break
                                            }
                                        }
                ...
                if (!($a = vh)) {
                    var xh;
                    if (xh = xb) a: {
                        for (var Pr = xb.include_conditions || [], OB = HA(a), al = 0; al < Pr.length; al++)
                ...
                if (bl) {
                    ...
                    for (var Xr = bl.synthesis_rules || [], dl = 0; dl < Xr.length; dl++) {
                        ...
                        if (vx(zh.eventName, zh.M, rf.event_name_predicate, rf.conditions || [])) {
                            ...
                            if (!dA(el)) {
                                var fl = rf.merge_source_event_params ? wc(zh.M) : {};
                                fl[T.vc] = !0;
                                eA(el, fl, rf);
                                Tq(el, fl, zh.va);
                                bA(1)
            ...
            this.zk();
            if (a.Ma()) {
                var TB = AB[1] ? a.metadata.is_conversion : a.Db;
                ...
                if (b ^ c && a.o && a.s && a.g) {
                    ...
                    if (c) {
                        ...
                        if (f) {
                            a.g = f;
                            var g = tA(a.o);
                            e || g ? a.s = g : sA(a.s, a.o)
                        } else oA(a.g, a.o), kA(a.g, !0), sA(a.s, a.o);
                        var h = {};
                        h[T.og] = d;
                        Sq(T.Ke, h, a.$a);
                    } else {
    ...
    var GB = function(a) {
            if (a.B(T.Ag)) a.g = !1, a.metadata.euid_mode_enabled = !1;
            else {
        ...
        JB = function(a) {
            var b = Object.keys(AB);
            if (b.length) {
                b.forEach(function(d) { AB[d] && lg("CCD", Number(d)) });
                var c = mg("CCD");
                c && (a.pf = "ccd." + c)
            }
        },
    ...
    function EB(a) {
        delete a.eventModel[T.Ib];
        LB(a.eventModel)
    }
    var LB = function(a) {
        Pa(a, function(c) { "_" === c.charAt(0) && delete a[c] });
        var b = a[T.Ka] || {};
    ...
    Z.h.ehl = ["google"],
        function() {
            ...
            function e() {
                var k = { source: null, state: X("history").state || null, url: Et(Ct()), N: Dt(Ct()) };
                return function(n, p) {
                    var q = k,
                        r = {};
                    r[q.source] = !0;
                    r[n.source] = !0;
                    if (!r.popstate || !r.hashchange || q.N != n.N) {
                        var t = { event: "gtm.historyChange-v2", "gtm.historyChangeSource": n.source, "gtm.oldUrlFragment": k.N, "gtm.newUrlFragment": n.N, "gtm.oldHistoryState": k.state, "gtm.newHistoryState": n.state, "gtm.oldUrl": k.url, "gtm.newUrl": n.url, "gtm.triggers": p.join(",") };
                        k = n;
                        Gt(t)
                    }
                }
            ...
            (function(k) {
                ...
                if (Lt("ehl")) {
                    ...
                    var t = function(u) { for (var v = 0; v < h.length; v++) h[v](u) };
                    b(n, t);
                    c(n, t);
                    d("pushState", n, t);
                    d("replaceState", n, t);
        ...
        function() {
            ...
            function g() {
                ...
                var B = 0,
                    D = !1,
                    C = function() {
                        D ? B = At(C, w) : (B = 0, f(), Lt("sdl") && !a() && ($b(t, "scroll", E), $b(t, "resize", E), ct("sdl", "init", !1)));
                        D = !1
                    },
                    E = function() {
                        A && x();
                        B ? D = !0 : (B = At(C, w), ct("sdl", "pending", !0))
                    };
                return E
            }
            ...
            function n(w) {
                ...
                Lt("sdl") ? et("sdl", "pending") || (y || (d(), y = !0), I(function() { return f() })) : (d(), y = !0, v && (Mt("sdl"), ct("sdl", "pending", !0), I(function() {
                    f();
                    if (a()) {
                        var Q = g();
                        Zb(t, "scroll", Q);
            ...
            })(function(w) { w.vtp_triggerStartOption ? n(w) : ls(function() { n(w) }) })
        }();
    ...
    Z.h.read_container_data = ["google"],
        function() {
            ...
            })(function() { return { assert: function() {}, U: function() { return {} } } })
        }();
    Z.h.c = ["google"],
        function() {
            (function(a) {
            ...
            })(function(a) { Nt(a.vtp_value, "c", a.vtp_gtmEventId); return a.vtp_value })
        }();
    Z.h.e = ["google"],
        function() {
            (function(a) {
    ...
    Z.h.v = ["google"],
        function() {
            (function(a) {
                ...
                var c = Ft(b.replace(/\\\./g, "."), a.vtp_dataLayerVersion || 1),
                    d = void 0 !== c ? c : a.vtp_defaultValue;
                Nt(d, "v", a.vtp_gtmEventId);
                return d
            })
        }();
    ...
    Z.h.ytl = ["google"],
        function() {
            ...
            function d(u, v) {
                if (!u.getAttribute("data-gtm-yt-inspected-" + v.Xa) && (u.setAttribute("data-gtm-yt-inspected-" + v.Xa, "true"), c(u, v.yb))) {
                    u.id || (u.id = a());
                    var y = X("YT"),
                        x = y.get(u.id);
                    x || (x = new y.Player(u.id));
                    var w = f(x, v),
                        A = {},
                        B;
                    for (B in w) A.Fc = B, w.hasOwnProperty(A.Fc) && x.addEventListener(A.Fc, function(D) { return function(C) { return w[D.Fc](C.data) } }(A)), A = { Fc: A.Fc }
                }
            }
            ...
            function f(u, v) {
                ...
                function w() {
                    J = yt(function() { return { url: M, title: V, ke: N, Af: u.getCurrentTime(), playbackRate: ba } }, v.Xa, u.getIframe());
                    N = 0;
                    V = M = "";
                    ba = 1;
                    return A
                ...
                function E() {
                    ...
                    v.cd && Gt(J.createEvent("complete", 1));
                ...
                function K() {
                    if (R.length && 0 !== ba) {
                        ...
                        do {
                            Ia = R[0];
                            if (Ia.W > u.getDuration()) return;
                            Ba = (Ia.W - u.getCurrentTime()) / ba;
                            if (0 > Ba && (R.shift(), 0 === R.length)) return
                        } while (0 > Ba);
                        y = function() {
                            x = 0;
                            y = F;
                ...
                y = F;
                return {
                    onStateChange: function(Ba) { Ga = Ga(Ba) },
                    onPlaybackRateChange: function(Ba) {
                        S = u.getCurrentTime();
                        sa = Bt().getTime();
                        J.ib();
                        ba = Ba;
            ...
            function g(u) {
                for (var v = u.split(","), y = v.length, x = [], w = 0; w < y; w++) {
                    var A = parseInt(v[w], 10);
                    isNaN(A) || 100 < A || 0 > A || x.push(A / 100)
                }
                x.sort(function(B, D) { return B - D });
                return x
            }
            ...
            function n(u) {
                ...
                if (v || y || x || w.length || A.length) {
                    ...
                    if (C) C.ready && C.ready(E);
                        ...
                        Ht("onYouTubeIframeAPIReady", function() {
                            F && F();
                            E()
                        });
                        I(function() {
                            for (var Q = X("document"), K = Q.getElementsByTagName("script"), J = K.length, R = 0; R < J; R++) { var N = K[R].getAttribute("src"); if (b(N, "iframe_api") || b(N, "player_api")) return }
                            for (var M = Q.getElementsByTagName("iframe"), V = M.length, ba = 0; ba < V; ba++)
                                if (!t && c(M[ba], D.yb)) {
            ...
            })(function(u) { u.vtp_triggerStartOption ? n(u) : ul(function() { n(u) }) })
        }();
                ...
                for (var v = [u], y = 0; y < t.length; y++) {
                    ...
                    if (x.hasOwnProperty("is_regex"))
                        if (x.is_regex) try { x = new RegExp(x.domain) } catch (B) { continue } else x =
                            x.domain;
                    var w = d(r);
                    if (x instanceof RegExp) { if (x.test(w)) return !1 } else {
                        var A = x;
                        if (0 != A.length) {
    ...
    Z.h.dlm = ["google"],
        function() {
            (function(a) {
                ...
                var b = My(a.vtp_userInput || [], "key", "value") || {};
                                    ...
                                    var r = X((fc(g, "target") || "_self").substring(1)),
                                        ...
                                        u = Ms(function() {
                                            ...
                                            if (v = t && r) {
                                                ...
                                                a: if (q) {
                                                        var x;
                                                        try { x = new MouseEvent(f.type, { bubbles: !0 }) } catch (w) {
                                                            if (!c.createEvent) { y = !1; break a }
    ...
    YB.callback = function(a) {
        Jh.hasOwnProperty(a) && Ea(Jh[a]) && Jh[a]();
        delete Jh[a]
    };
    YB.bootstrap = 0;
    YB._spx = !1;
    (function(a) {
        if (!m["__TAGGY_INSTALLED"]) {
            ...
            if (H.referrer) {
                var c = pi(H.referrer);
                b = "cct.google" === mi(c, "host")
            }
            if (!b) {
                var d = Ti("googTaggyReferrer");
        ...
        if (b) {
            ...
            for (var t = g.rules || [], u = 0; u < t.length; u++) {
                for (var v = t[u], y = {}, x = 0; x < v.length; x++) y[v[x][0]] = Array.prototype.slice.call(v[x], 1);
                oe.push(y)
            }
            se = Z;
            te = pu;
            ...
            for (var F = 0; F < B.length; F++) {
                var Q = B[F];
                if (!Ja(Q) || 3 > Q.length) { if (0 === Q.length) continue; break }
                D && D[F] && D[F].length && Ce(Q, D[F]);
                Ey.execute(Q)
            }
            if (void 0 !==
                w)
                for (var K = ["sandboxedScripts"], J = 0; J < w.length; J++) {
                    var R = w[J].replace(/^_*/, "");
                    Kh[R] = K
                }
            Iy(A);
